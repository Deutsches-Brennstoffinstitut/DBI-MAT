...
from dbimat.source.basic.Streamtypes import StreamEnergy, StreamMass
...
class Source(GenericUnit):
    class Technology(Enum):
        WIND_ONSHORE = auto()  # creates string from paramter name
        WIND_OFFSHORE = auto()  # creates string from paramter name
        PV_OPEN_AREA = auto()
        PV_ROOF = auto()
