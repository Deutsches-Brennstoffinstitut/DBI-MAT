from dbimat.source.basic.Quantities import *
...
from dbimat.source.helper import RefPropFluid
import os.path
import math
import sys
...
from dbimat.source.basic.CustomErrors import PortMassError
...
class Port_Mass(Port):
    ...
    def _create_fluid(self) -> RefPropFluid:
        ...
        my_abstract_state = AbstractState("HEOS", components_string)
